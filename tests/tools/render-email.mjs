...
const SAMPLE = {
  ...
  'session.wind_speed_avg_kn': '23',
  'session.best_hours': '3',
  'session.wind_speed_session_avg_kn': '21',
  ...
  'hype.tease': '31 knots over the best three hours, 5 rideable, SW at Rivierwoods Beachclub, peaking at 34. Charge the camera, pump up early, and don\u2019t be the one who hears about it afterwards.',
  calendar_html: '',
  live_html: '',
}
